...
final class NewsNetworkService {
    ...
    func loadArticle(completion: @escaping (Article?, Error?) -> Void) {
        let url = "https://newsapi.org/v2/everything?from=2022-02-15&sortBy=publishedAt&apiKey=19212336d40e463bbd18132edfa2f299&language=ru&q=%D0%BF%D0%BE%D0%B3%D0%BE%D0%B4%D0%B0&domains=onliner.by"
